...
public static class UltiDraw
{
    ...
    public static void DrawArrow(Vector3 start, Vector3 end, float ArrowStart, float LineWidth, float ArrowWidth, Color color)
    {
        ArrowStart = Mathf.Clamp(ArrowStart, 0f, 1f);
        Vector3 pivot = start + ArrowStart * (end - start);
        DrawLine(start, pivot, LineWidth, color);
        DrawLine(pivot, end, ArrowWidth, 0f, color);
    }
